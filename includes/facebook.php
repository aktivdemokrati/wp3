...
?>
  if( $('#registerform').size() )
    ...
    {
	$('#loginform').append('<p style="clear:both;margin-top:3em">eller</p><p><a id="fb-auth" class="fb_button fb_button_medium"><span class="fb_button_text">Logga in utan lösenord</span></a></p>');
